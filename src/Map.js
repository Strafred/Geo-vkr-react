                    ...
                    {this.state.loadedStations.map((station) => (
                        <Marker position={[station.latitude, station.longitude]}
                            ...
                            <Popup>
                                ...
                                <ul id="div_top_hypers" className="popupList"><strong>Channel, Latitude, Longitude, Elevation, Depth,
                                    Azimuth, Dip, SampleRate:</strong>
                                    {station.channels.map((channel) => (
                                        <li class="a_top_hypers">{channel.currentChannelName} | {channel.latitude} | {channel.longitude} |
